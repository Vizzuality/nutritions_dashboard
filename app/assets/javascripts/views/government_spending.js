(function(App) {
  ...
  App.View.GovernemntSpendingView = App.View.Chart.extend({

    initialize: function() {
      this.status = new Backbone.Model({});
      this.model = new App.Model.CountriesModel();

      App.View.GovernemntSpendingView.__super__.initialize.apply(this);
    ...
    _fetchData: function() {
      ...
      // };
      this.model.getDataForGovernemntSpending().done(function(){
        this.render();
      }.bind(this));
    },
    ...
    _drawGraph: function() {
      ...
      var svg = d3.select('#governmentSpending .c-chart')
